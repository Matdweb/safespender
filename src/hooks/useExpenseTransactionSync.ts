...
import { useExpenses, useTransactions, useCreateTransaction } from '@/hooks/useFinancialData';
...
export const useExpenseTransactionSync = () => {
  ...
  useEffect(() => {
    ...
    const syncExpenseTransactions = async () => {
  ...
  }, [expenses, transactions, createTransactionMutation]);
};